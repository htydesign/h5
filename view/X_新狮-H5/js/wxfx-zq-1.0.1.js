...
function wxjdksz() {
    ...
    wx.ready(function () {
    	var imgUrl = 'http://creative.trendyactivity.com/images/share.jpg';  //分享后展示的一张图片
        var lineLink = 'http://creative.trendyactivity.com/index.html'; // 点击分享后跳转的页面地址
        var shareTitle = '新狮界的大门，你打得开吗？';  // 分享后的标题
        var descContent = "没试过怎么知道呢！";  // 分享后的描述信息
