...
function wxjdksz() {
    ...
    wx.ready(function () {
    	var imgUrl = 'http://demo.trendyactivity.com/hty/huazhan/images/share.jpg';  //分享后展示的一张图片
        var lineLink = 'http://demo.trendyactivity.com/hty/huazhan/index.html'; // 点击分享后跳转的页面地址
        var shareTitle = '听说这是薛之谦都珍藏的影集';  // 分享后的标题
        var descContent = "金立S10摄影展曝光了薛之谦的工作照、生活照和自拍照";  // 分享后的描述信息
