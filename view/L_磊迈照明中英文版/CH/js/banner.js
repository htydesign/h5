...
jQuery(document).ready(function() {
	api2 = jQuery('.fullwidthbanner2').revolution({
		delay: 9000,
		startheight: 1133,
		startwidth: 2560,
...
jQuery(document).ready(function() {
	api3 = jQuery('.fullwidthbanner3').revolution({
		delay: 9000,
		startheight: 1080,
		startwidth: 2560,
...
jQuery(document).ready(function() {
	api4 = jQuery('.fullwidthbanner4').revolution({
		delay: 9000,
		startheight: 400,
		startwidth: 800,
...
jQuery(document).ready(function() {
	api5 = jQuery('.fullwidthbanner5').revolution({
		delay: 9000,
		startheight: 506,
		startwidth: 1074,
...
jQuery(document).ready(function() {
	api6 = jQuery('.fullwidthbanner6').revolution({
		delay: 9000,
		startheight: 570,
		startwidth: 1286,
...
jQuery(document).ready(function() {
	api7 = jQuery('.fullwidthbanner7').revolution({
		delay: 9000,
		startheight: 570,
		startwidth: 1286,
...
jQuery(document).ready(function() {
	api8 = jQuery('.fullwidthbanner8').revolution({
		delay: 9000,
		startheight: 570,
		startwidth: 1286,
