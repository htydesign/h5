...
var jurl = "https://xcx.trendyactivity.com/ajax/wxfxajax.aspx";
...
function wxjdksz() {
    ...
    wx.ready(function () {
    	var imgUrl = 'https://static.vivo.com.cn/hd/images/share.jpg';  //分享后展示的一张图片
        var lineLink = 'https://hd.vivo.com.cn/vivox21lh/index.html'; // 点击分享后跳转的页面地址
        var shareTitle = '和鹿晗一起打开X21的秘密';  // 分享后的标题
        var descContent = "或许这个秘密，只有鹿晗和你才知道喔"; // 分享后的描述信息
