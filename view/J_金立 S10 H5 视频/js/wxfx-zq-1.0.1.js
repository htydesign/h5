...
function wxjdksz() {
    ...
    wx.ready(function () {
    	var imgUrl = 'http://gionees10.trendyactivity.com/images/share.jpg';  //分享后展示的一张图片
        var lineLink = 'http://gionees10.trendyactivity.com/index.html'; // 点击分享后跳转的页面地址
        var shareTitle = '好像在哪见过你？那就来看薛之谦一面';  // 分享后的标题
        var descContent = "薛之谦拍照神器曝光";  // 分享后的描述信息
