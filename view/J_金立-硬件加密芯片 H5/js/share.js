...
function wxJDKAuthorize() {
    ...
    wx.ready(function() {
        var imgUrl = 'http://synia.wutaiwei.com/images/share.png';  //分享后展示的一张图片
        var lineLink = 'http://gioneem6jm.wutaiwei.com/'; // 点击分享后跳转的页面地址
        var shareTitle = '什么？国庆宅在家里也不安全！！';  // 分享后的标题
        var descContent = "国庆宅在家刷屏就安全？病毒木马入侵、隐私泄露，怎么正确解锁手机安全隐患？";  // 分享后的描述信息
