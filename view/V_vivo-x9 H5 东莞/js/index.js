var container = document.getElementById("container"),
	...
	lightMaterial,
	lightPlaneMesh,
	oGeo1,oGeo2,oGeo3,oMat1,oMat2,oMat3,oMesh1,oMesh2,oMesh3,stats;
...
$('.box').on('touchstart', function() {
	if(tt){		
		//setAnimation();		
		$('.light').remove();
//		var oImgAnimateBox=document.querySelector('.imgAnimate');
//		var aImgAnimate=document.querySelectorAll('.imgAnimate img');
//		var aa=0;
//		var bb=null;
...
//				clearInterval(bb);
//			}else{
//				oImgAnimateBox.removeChild(aImgAnimate[aa]);
//				aa++;
//			}
//		},30);
...
function playDraw(){
	...
	let canvas=document.getElementById("loadMain");
	
	canvas.width=nWidth;
	canvas.height=nHeight;
	
	//创建舞台
	let stage = new createjs.Stage("loadMain");
	...
	function playFrame(i) {
		var bitmap = new createjs.Bitmap("images/"+i+".jpg");
		bitmap.x = bitmap.y = 0;
		//bitmap.scaleX = nWidth / 320;
		//bitmap.scaleY = nHeight / 640;
...
function init() {
	...
	//var _ratio = isAndriod() ? window.devicePixelRatio/2 : window.devicePixelRatio ;
